...
public class MsRecommendationIntegration {
	...
	private static final String RECOMMENDATION_SERVICE_URL = "http://ms-recommendation";
	...
	@Autowired
	public MsRecommendationIntegration(@Qualifier("publishEventScheduler") Scheduler publishEventScheduler,
	...
	public Flux<RecommendationDto> getRecommendations(int productId) {
		...
		LOGGER.debug("Se llamará a getRecommendations API en URL: {}", url);

		// Se retorna un resultado vacío si algo sale mal para que el servicio de Product-Composite pueda retornar respuestas parciales
	...
	public Mono<Void> deleteRecommendations(int productId) {
		return Mono
				.fromRunnable(() -> sendMessage("recommendations-out-0", new Event(Event.Type.DELETE, productId, null)))
