...
public class ProductServiceController {
	...
	public ProductDto createProduct( @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Datos del usuario a registrar",
		...
		LOGGER.debug("createProduct: producto creado para productId: {}", body.getProductId());
		return body;
	}
	...
	public void deleteProduct(@Parameter(description = "${api.product.delete-product.parameters.productId}", required = true) 
							@PathVariable int productId) {
