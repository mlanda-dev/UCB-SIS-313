...
public class ProductCompositeController {
	...
	public ProductAggregateDto getProduct(
	...
	private void createProductAggregate( @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "${api.product-composite.schema.product-composite.description}",
            required = true, content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProductAggregateDto.class)))
			@RequestBody ProductAggregateDto body) {
	...
	public void deleteProduct(@Parameter(description = "${api.product-composite.delete-composite-product.parameters.productId}", required = true)
