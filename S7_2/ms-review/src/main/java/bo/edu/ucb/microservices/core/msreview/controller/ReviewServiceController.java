...
public class ReviewServiceController {
	...
	public List<ReviewDto> searchReview( 
		...
		return reviewService.searchReviews(subject);
	}
	
	@GetMapping(value = "/get/{reviewId}", produces = "application/json")
	public ReviewDto getReviewById( 
			@PathVariable(name = "reviewId") int id) {
		return reviewService.getReviewById(id);
	}
	
	@GetMapping(value = "/get2/{reviewId}", produces = "application/json")
	public ReviewDto getReviewById2( 
			@PathVariable(name = "reviewId")  int id) {
		return reviewService.getReviewById2(id);
	}
}
